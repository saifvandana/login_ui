...
import 'package:login_ui/pages/notifications.dart';
import 'package:scrollable_positioned_list/scrollable_positioned_list.dart';

import 'input.dart';

// import 'package:login_ui/screens/beauty.dart';
// import 'package:login_ui/screens/fashion.dart';
// import 'package:login_ui/screens/notifications.dart';
// import 'package:login_ui/screens/search.dart';
...
class Navbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Navbar(
      ...
      this.noShadow = false,
      this.bgColor = LoginUIColors.white,
                        ...
                        IconButton(
                            icon: Icon(
                                ...
                                color: !widget.transparent
                                    ? (widget.bgColor == LoginUIColors.white
                                        ? LoginUIColors.info
                                        : LoginUIColors.white)
                                    : LoginUIColors.white,
                                size: 24.0),
                ...
                if (widget.searchBar)
                  Padding(
                    ...
                    child: Input(
                        ...
                        suffixIcon:
                            Icon(Icons.zoom_in, color: LoginUIColors.muted),
                        onTap: () {
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.camera,
                                color: LoginUIColors.info, size: 22.0),
                            SizedBox(width: 10),
